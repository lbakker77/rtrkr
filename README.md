...
## About
This project is mainly intended as a personal practice project to try out new things (e.g. Angular Signals and NGRX Signal Store, Spring Modulith, Websockts with Stomp). Nevertheless, the project aims to be production-ready although I do not plan to deploy and run it. 
